...
function verifyQuantity() {
  ...
  quantity.addEventListener('change', () => {  //Fonction traitant les divers cas de valeurs saisies
    ...
    } else if (document.querySelector('.item__content__settings__quantity p')) {
      document.querySelector('.item__content__settings__quantity p').innerText = "Veuillez entrer un nombre s'il vous plait" 
    }
    return console.error('not a number')
      ...
      if (!document.querySelector('.item__content__settings__quantity p')) {
        ...
        document.querySelector('.item__content__settings__quantity p').innerText = "La quantité minimale à ajouter au panier est de un (1)"
      }
      ...
      if (!document.querySelector('.item__content__settings__quantity p')){
        ...
        document.querySelector('.item__content__settings__quantity p').innerText = "La quantité maximale est de cent (100)"
      }
